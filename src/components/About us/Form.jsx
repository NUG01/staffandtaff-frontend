    ...
    <div className={styles.formContent}>
        ...
        <form onSubmit={(e) => handleSubmit(e)} className={styles.formController}>
            <div className={styles.inputControl}>
                ...
                className={validation.name ? styles.singleInput : styles.singleInputInvalid} 
                type="text" 
                name='name' 
                id='name'/>
            ...
            <div className={styles.inputControl}>
                ...
                <input
                 onChange={(e) => handleChange(e)}
                  ...
                  placeholder='E-mail' 
                  className={validation.email ? styles.singleInput : styles.singleInputInvalid} 
                  type="email" 
                  name='email' 
                  id='email'/>
            </div>
            <div className={styles.inputControl}>
                ...
                placeholder='Message' 
                maxLength={1000} 
                className={validation.message ? styles.singleInput : styles.singleInputInvalid} 
                name="message" 
            ...
            <div className={styles.checkbox}>
                ...
                className={validation.confirm ? styles.checkboxInput : styles.checkboxInputInvalid} 
                onChange={(e) => handleChange(e)} 
                type="checkbox"
                name="confirm" />

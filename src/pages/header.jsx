            ...
            <header
                ...
                {!userAuthCheck && (
                    <Link
                        ...
                        <p className={userAuthCheck ? 'hide-nav' : ''}>
                    ...
                    <>
                        <div
                            ...
                            <div className="account-panel-wrapper">
                                <AccountPanelIcon profile={profile} />{' '}
                                <span>Bonjour, {user.data.name}</span>
                                <div className="hover-panel">
                                    <Link href="/profile">
                                        <img src="profile.png" alt="" /> My
                                        Profile
                                    </Link>
                                    <Link href="/jobs">
                                        <img src="submissions.png" alt="" /> My
                                        Submissions
                                    </Link>
                                    <Link href="/jobs">
                                        <img src="settings.png" alt="" /> My
                                        Settings
                                    </Link>
                                    <a onClick={() => logout()}>
                                        <img src="power-icon.png" alt="" /> Log
                                        Out
                                    </a>
                                </div>
                            </div>
            ...
            {userAuthCheck && (
                <div
                    className={`${
                        active === 'login' || active === 'register'
                            ? 'hide-nav'
                            : 'mobile-auth-nav logout-auth-nav'
                    }`}
                    onClick={logout}>
                    <p>DÉCONNEXION</p>
                </div>
